    ...
    return (
        <div>
            <div className='bg-[#9538E2] lg:mx-[30px] md:mx-[30px] mx-[15px] lg:pb-[268px] md:pb-[200px] pb-[150px] text-center rounded-b-[32px]'>
                ...
                <button className='text-[#9538E2] font-bold text-[20px] bg-white sm:py-[15px] sm:px-[30px] py-[10px] px-[20px] rounded-[32px] hover:text-white hover:bg-violet-700'>
                    Shop Now
                </button>
            </div>
            <div className='lg:w-8/12 md:w-9/12 w-10/12 mx-auto lg:p-6 md:p-6 p-2 border-[3px] border-white bg-[#FFFFFF4D] relative lg:top-[-230px] md:top-[-180px] top-[-130px] rounded-[32px] '>
